...
process.s1 = cms.Sequence(process.muonsFilter * process.MuMuFilter)
process.p1 = cms.Path(process.s1)

process.s2 = cms.Sequence(process.electronsFilter * process.ElElFilter)
process.p2 = cms.Path(process.s2)

process.s3 = cms.Sequence(process.muonsFilter * process.electronsFilter * process.ElMuFilter)
